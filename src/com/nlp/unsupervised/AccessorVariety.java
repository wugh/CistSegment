...
/**
 * 用来计算每个字串的AV值
 * 提供新的AV特征使用方法，详细资料参考论文
 */
public class AccessorVariety {
    // 存储字串的AV值
    ...
    */
     ...
     */
    public AccessorVariety(String inputFile) throws IOException {
...
//                        contentLines.addAll(simpleLineToSentences(smallLine));
    ...
    public static void main(String[] args) throws IOException {
        AccessorVariety avtool = new AccessorVariety("corpus/train/2010/2010-train-test");
